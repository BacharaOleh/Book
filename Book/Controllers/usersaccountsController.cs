...
namespace Book.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(BookContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.usersaccounts != null ? 
                          ...
                          Problem("Entity set 'BookContext.usersaccounts'  is null.");
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\USERS\\OLEGB\\ONEDRIVE\\ДОКУМЕНТИ\\MYNEWDB3.MDF;Integrated Security=True;Connect Timeout=30");
            string sql;
